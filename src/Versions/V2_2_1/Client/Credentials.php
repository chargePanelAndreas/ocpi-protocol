...
use Chargemap\OCPI\Versions\V2_2_1\Client\Credentials\Delete\DeleteCredentialsRequest;
use Chargemap\OCPI\Versions\V2_2_1\Client\Credentials\Delete\DeleteCredentialsResponse;
use Chargemap\OCPI\Versions\V2_2_1\Client\Credentials\Delete\DeleteCredentialsService;
use Chargemap\OCPI\Versions\V2_2_1\Client\Credentials\Get\GetCredentialsRequest;
use Chargemap\OCPI\Versions\V2_2_1\Client\Credentials\Get\GetCredentialsResponse;
use Chargemap\OCPI\Versions\V2_2_1\Client\Credentials\Get\GetCredentialsService;
...
use Chargemap\OCPI\Versions\V2_2_1\Client\Credentials\Put\PutCredentialsRequest;
use Chargemap\OCPI\Versions\V2_2_1\Client\Credentials\Put\PutCredentialsResponse;
use Chargemap\OCPI\Versions\V2_2_1\Client\Credentials\Put\PutCredentialsService;
...
class Credentials extends AbstractFeatures
{
     ...
     */
    public function register(PostCredentialsRequest $request): PostCredentialsResponse
    {
     ...
     * @throws \Psr\Http\Client\ClientExceptionInterface
     */
    public function update(PutCredentialsRequest $request): PutCredentialsResponse
    {
     ...
     * @throws \Psr\Http\Client\ClientExceptionInterface
     */
    public function unregister(DeleteCredentialsRequest $request): DeleteCredentialsResponse
    {
